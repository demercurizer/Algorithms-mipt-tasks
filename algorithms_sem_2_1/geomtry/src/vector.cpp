...
Vector::Vector(const int64_t &x_input, const int64_t &y_input)
    : x_(x_input), y_(y_input) {}

Vector::Vector(const Point &point_1, const Point &point_2)
    : x_(point_2.GetX() - point_1.GetX()), y_(point_2.GetY() - point_1.GetY()) {
}
